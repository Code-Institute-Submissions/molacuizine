"""
Django settings for mo_lacuizine project.
...
ROOT_URLCONF = 'mo_lacuizine.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'mo_lacuizine', 'templates/mo_lacuizine'),
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'mo-lacuizine'
